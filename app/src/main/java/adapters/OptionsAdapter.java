...
import dataInLists.DataInPersonalOptions;


public class OptionsAdapter extends BaseAdapter {

    public static final String TAG = OptionsAdapter.class.getSimpleName();
    private ArrayList<DataInPersonalOptions.OptionsValues> valuesArrayList;
    private LayoutInflater inflater;

    public OptionsAdapter(Context ctx, ArrayList<DataInPersonalOptions.OptionsValues> valuesArrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        tv_text1.setText(valuesArrayList.get(i).title+"");
