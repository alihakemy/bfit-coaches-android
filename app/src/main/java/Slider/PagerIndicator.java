...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    private PagerIndicator.Shape mIndicatorShape = PagerIndicator.Shape.Oval;
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        int visibility = attributes.getInt(R.styleable.PagerIndicator_visibility, com.daimajia.slider.library.Indicators.PagerIndicator.IndicatorVisibility.Visible.ordinal());
        ...
        int shape = attributes.getInt(R.styleable.PagerIndicator_shape, PagerIndicator.Shape.Oval.ordinal());
        ...
        setDefaultSelectedIndicatorSize(mDefaultSelectedWidth,mDefaultSelectedHeight, com.daimajia.slider.library.Indicators.PagerIndicator.Unit.Px);
        setDefaultUnselectedIndicatorSize(mDefaultUnSelectedWidth,mDefaultUnSelectedHeight, com.daimajia.slider.library.Indicators.PagerIndicator.Unit.Px);
    ...
    public void setDefaultSelectedIndicatorSize(float width, float height, com.daimajia.slider.library.Indicators.PagerIndicator.Unit unit){
        if(mUserSetSelectedIndicatorResId == 0){
            float w = width;
            float h = height;
            if(unit == com.daimajia.slider.library.Indicators.PagerIndicator.Unit.DP){
                w = pxFromDp(width);
                h = pxFromDp(height);
            }
    ...
    public void setDefaultUnselectedIndicatorSize(float width, float height, com.daimajia.slider.library.Indicators.PagerIndicator.Unit unit){
        if(mUserSetUnSelectedIndicatorResId == 0){
            float w = width;
            float h = height;
            if(unit == com.daimajia.slider.library.Indicators.PagerIndicator.Unit.DP){
    ...
    public void setDefaultIndicatorSize(float width, float height, com.daimajia.slider.library.Indicators.PagerIndicator.Unit unit){
