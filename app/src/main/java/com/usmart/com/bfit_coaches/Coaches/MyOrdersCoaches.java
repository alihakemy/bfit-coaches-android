package com.usmart.com.bfit_coaches.Coaches;
...
import com.usmart.com.bfit_coaches.Chats;
...
import customLists.Coaches.CustomListCoachSubscribe;
...
public class MyOrdersCoaches extends Activity {

    Activity activity = MyOrdersCoaches.this;
    SharedPreferences Login;
    DataInCoachesSubscribe _Data = new DataInCoachesSubscribe();

    GridView lv;
    CustomListCoachSubscribe adapter2;
    TextView MainTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setNumColumns(1);
        adapter2 = new CustomListCoachSubscribe(activity, new ArrayList<>());
        lv.setAdapter(adapter2);

        MainTitle = findViewById(R.id.MainTitle);

        MainTitle.setText(R.string.customerSubscribers);
    ...
    private void loadOrders() {
        ...
        Url = Values.Link_service + "coach/start/subscribers/" + lang + "/v1";
        ...
        client.get(Url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, String arg1) {
                ...
                try {
                    Gson g = new Gson();
                    Type t = new TypeToken<DataInCoachesSubscribe>() {
                    }.getType();
    ...
    protected void onResume() {
        ...
        try {
            if (LoginHolder.getInstance().getData().equals("login")) {
                ...
                startActivity(new Intent(activity, com.usmart.com.bfit_coaches.Login.class));
            }
        } catch (Exception e) {
