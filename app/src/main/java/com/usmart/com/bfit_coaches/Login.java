...
public class Login extends Activity {
    ...
    TextView MainTitle, ForgetPassword, HasNewAccount, Register, tv_changeLanguage;
    ImageView HideAll;
    ProgressBar prog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Login.setOnClickListener(v -> {
            ...
            String Url = Values.Link_service + "coach/login/" + lang + "/v1";
            String json = new StringBuilder()
                    .append("{")
                    .append("\"phone\":\"" + Mobile.getText().toString() + "\",")
                    ...
                    .append("}").toString();
            Log.d(TAG, json);
            //   Log.i("TestApp_token", FirebaseInstanceId.getInstance().getToken());
                    ...
                    try {
                        ...
                        activity.runOnUiThread(() -> {
                            if (!LoginData.success) {
                                ...
                                loadMsg(getResources().getString(R.string.loginError));
                            } else {
