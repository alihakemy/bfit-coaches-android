...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FirebaseInstanceId.getInstance().getInstanceId()
        ...
        Log.i("TestApp", screenWidth + " , " + screenHeight + " , " + dm.scaledDensity
                + " , " + dm.densityDpi + " , " + dm.xdpi);
    ...
    public void register() {
        ...
        body1.addFormDataPart("unique_id", Settings.Secure.getString(getContentResolver(), Settings.Secure.ANDROID_ID) + "");
        body1.addFormDataPart("fcm_token", FirebaseInstanceId.getInstance().getToken() + "");
        body1.addFormDataPart("type", 2 + "");
