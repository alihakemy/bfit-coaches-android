...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // Log.i(TAG, "Message Notification " + remoteMessage + "");


        // Log.i(TAG, "Message Image " + remoteMessage.getNotification().getTitle() + "");
        sendNotification(remoteMessage);
        Intent intent = new Intent("productData");
    ...
    public void onNewToken(String token) {
        Log.i(TAG, "MyFirebaseMsgService Refreshed token: " + token);
    ...
    private void sendNotification(RemoteMessage messageBody) {
        ...
        Log.i(TAG, "Message Image " + imageUri + "");
        ...
        if (imageUri.isEmpty()) {
            Log.i(TAG, "Message Image " + messageBody.getNotification().getImageUrl() + "");
            notificationBuilder =
            ...
            Log.i(TAG, "Message Title " + messageBody.getNotification().getTitle() + "");
            notificationBuilder =
                    new NotificationCompat.Builder(getApplicationContext(), channelId)
                            .setSmallIcon(R.mipmap.checked4)
                            .setContentTitle(messageBody.getNotification().getTitle() + "")
